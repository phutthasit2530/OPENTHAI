...
echo -e "${RED} #         BY : อิคคิวซัง               #    "
echo -e "${RED} #    FB : อิคคิวซัง       #    "
echo -e "${RED} =============== OS-32 & 64-bit =================    "
...
END
	...
	echo "<pre>by อิคคิวซัง | OPENTHAI</pre>" > /home/vps/public_html/index.html
...
echo ""
	cd /usr/local/bin
wget -q -O m "https://raw.githubusercontent.com/phutthasit2530/OPENTHAI/master/Menu"
chmod +x /usr/local/bin/m
	wget -O /usr/local/bin/Auto-Delete-Client "https://raw.githubusercontent.com/phutthasit2530/OPENTHAI/master/Auto-Delete-Client"
